...
import com.capgemini.chess.dao.impl.PlayersStatisticsDaoImpl;
...
public class ChallengeServiceTest {
	...
	@Autowired
	private ChallengeService challengeServiceTest;
	...
	static class ChallengeServiceTestConfiguration {
		...
		@Bean
		public PlayersStatisticsDao playersStatisticsDao() {
			return new PlayersStatisticsDaoImpl();
		}
		@Bean
	 ...
	 */
	@Test
	public void shouldAddNewChallengeToTestListForInsertionOnly() {
		//given
		PlayerStatisticsTO challengingPlayer = PlayerStatisticsTOTestList.PLAYER_STATISTICS_TO_TEST_LIST.get(12);
		PlayerStatisticsTO challengedPlayer = PlayerStatisticsTOTestList.PLAYER_STATISTICS_TO_TEST_LIST.get(4);
		long properIdChallenge = 691122449817L;
		//when
